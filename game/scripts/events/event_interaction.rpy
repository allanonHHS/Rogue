...
label talkFrank:
    ...
    menu:
        ...
        'Рассказать о своей горькой доле (обман)' if trigger[21] == 0:
            $ trigger[21] = 1
    ...
    if trigger[8] == 2:
        ...
        if curloc.id != 'elsaRoom':
            ...
            menu:
                'Поболтать':
                    $ changetime(60)
                    'Вы вдоволь поболтали с Эльзой на всякие темы. Вам нравился её ум и весёлый склад характера. Но вскоре вы обе устали и отправились спать по своим кроватям.'
