init -20 python:
    ...
    class Char(object):
        ...
        maleLastNames = ['Торговец','Горожанин','Крестьянин', 'Алхимик', 'Нищий', 'Ремесленник', 'Кожевенник', 'Кузнец', 'Вор', 'Бард', 'Менестрель', 'Портной', 'Дворянин', 'Стражник', 'Наёмник', 'Купец','Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин', 'Крестьянин']
